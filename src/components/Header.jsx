...
const Header = () => {
  ...
  return (
    <>
      <section className="flex gap-8 flex-col xl:flex-row md:flex-row my-16 justify-around items-center">
        <div className="flex flex-col gap-5 mx-20 xl:mx-0">
          <h1 data-aos="fade-right" data-aos-duration="800" data-aos-delay="400" className="text-cinder-dark-mode text-6xl font-bold font-pjs xl:text-6xl">
            Kshitiz Sharma
          </h1>
          <p data-aos="fade-right" data-aos-duration="800" data-aos-delay="600" className="text-lg w-80 xl:w-96 leading-8 font-inter">
